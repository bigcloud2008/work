...
import com.tusvn.ccinfra.api.data.storage.RedisUtils.Hash;
import com.tusvn.ccinfra.api.data.storage.RedisUtils.Keys;
import com.tusvn.ccinfra.api.data.storage.RedisUtils.Lists;
import com.tusvn.ccinfra.api.data.storage.RedisUtils.Sets;
import com.tusvn.ccinfra.api.data.storage.RedisUtils.SortSet;
import com.tusvn.ccinfra.api.data.storage.RedisUtils.Strings;
...
public class RedisUtilsForTest {
	...
	static {
		...
		try {
			//////172.30.1.203:6379,172.30.1.204:6379,172.30.1.205:6379,172.30.1.206:6379,172.30.1.207:6379,172.30.1.208:6379
			String addr   	= ConfigProxy.getPropertyOrDefault("test.redis.hosts", "172.30.1.203:6379,172.30.1.204:6379,172.30.1.205:6379,172.30.1.206:6379,172.30.1.207:6379,172.30.1.208:6379");
